...
class AnswersViewController: UITableViewController, PlaygroundLiveViewMessageHandler, InputCellDelegate {
    ...
    override func viewDidLoad() {
        ...
        titleLabel.text = NSLocalizedString("No output to show", comment: "Title lablel when there is no output from the answers template")
        ...
        messageLabel.text = NSLocalizedString("Run your code to see your show() and ask() commands here", comment: "Content lablel when there is no output from the answers template")
